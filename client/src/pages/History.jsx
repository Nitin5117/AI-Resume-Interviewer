          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-slate-400">
                Review interviews, continue unfinished sessions,
                and access completed performance reports.
              </p>
            </div>
          </div>
        </section>
      ...
      {interview.status === "failed" && (
        <div className="mt-6 border-t border-red-500/20 pt-5">
          <p className="text-sm leading-6 text-red-300">
            The AI evaluation could not be
            completed. Your answers are saved and
            you can retry generating the report.
          </p>
        </div>
      )}
      ...
      {interview.status === "evaluating" && (
        <div className="mt-6 border-t border-violet-500/20 pt-5">
          <p className="text-sm leading-6 text-violet-300">
            Your interview is currently being
            evaluated. The report will be
  ...
  return (
    <div className="rounded-3xl border border-dashed border-slate-700 bg-slate-900/50 p-14 text-center">
      ...
      <p className="mx-auto mt-3 max-w-md text-slate-400">
        Start your first AI interview and your
